...
from ...calculations.efficiency import save, calc_tec_ctp, calc_eff, set_count_of_point, get_excel, calc_ner
...
# Расчёт ТЭЦ и ЦТП
@main.route("/calc_tec_ctp", methods=["POST"])
@token_auth.login_required
def api_calc_tec_ctp():
    try:
        data = calc_tec_ctp(request.json["cur_date"])
    except:
        data = None
