    ...
    return {
      ...
      [    
        ...
        // 20
        {
          ...
          input:[['Температура внутреннего воздуха','°C',  '', 'uint', false, [0, 6, '']], ['Длина здания','м', '', 'uint', false, [0, 2, '']],['Ширина здания','м', '', 'uint', false, [0, 3, '']], ['Этажность', '', '', 'uint', false, [0, 1, '']], ['Высота стен','м', '', 'uint', false, [0, 5, '']], ['Число подъёмов ГВС','ед.', '', 'uint', false, [3, 0, '']],['Число опусков ГВС','ед.', '', 'uint', false, [3, 1, '']]],
          r_btn:null, 
        ...
        // 21
        {
          ...
          input:[['Температура внутреннего воздуха','°C', '', 'uint', false, [0, 6, '']], ['Длина здания','м', '', 'uint', false, [0, 2, '']],['Ширина здания','м', '', 'uint', false, [0, 3, '']], ['Этажность', '', '', 'uint', false, [0, 1, '']], ['Высота стен','м', '', 'uint', false, [0, 5, '']], ['Число подъёмов от ТП до чердака','ед.', '', 'uint', false, [4, 0, '']],['Число опусков от чердака до ТП','ед.', '', 'uint', false, [4, 1, '']]],
          r_btn:null, 
          select:[['Тип трубы',[], [], '', [22,1, '']]],
          c_box:null,
          date:null,
